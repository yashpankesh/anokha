"""
Django settings for anokha project.
...
SECRET_KEY = 'django-insecure-=(s*s)-%8_r_qgd6lf69xxbd2(nn95%9@gnvx2#5-3ln02rz1a'
...
WSGI_APPLICATION = 'anokha.wsgi.application'
